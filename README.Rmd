...
registrations and voting in 2012. Specifically, given more time, we would have liked to investigate how many students are instead registered to vote in their home states and what factors might affect their decision to do so (convenience of mail-in voting, swing states, etc). We would also like to conduct interviews with Duke students to ask about voting habits, with particular interest in those who are registered to vote in North Carolina but choose not to do so.

Finally, there are several on-campus voter registration efforts whose leaders we would like to connect with, such as services offering free rides to polling places, those advocating for students to register to vote, and, most recently, a Duke Student Government initiative to cancel classes on election day. We believe these groups could provide insight as to what kind of response they receive from students, such as whether they claim to already be registered, are registered in their home state, or simply do not have the time to interact with these efforts. 
